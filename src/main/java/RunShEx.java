...
//		parseArgs(new String[] {"list", "--entity", "disease_10"});
		parseArgs(new String[] {"validate", "--schema", "disease_10", "--entity", "Q12135"});

//		Path base_url = Paths.get("src", "main", "resources", "manifest.json"); //manifest.json
		URL base_url = new URL("C:/workspace/verification/shex-java/shex/src/main/resources/manifest.json");
